     ...
     <div id="wrapper">
          <div id="page-wrapper">
               <div class="container-fluid">
                    ...
                    <div class="row">
                         <div class="col-md-6">
                              <form method="post" action="<?php echo base_url('admin/chat/send_chat'); ?>">
                                   <div class="panel panel-default">
                                        ...
                                        <div class="panel-footer">
                                             ...
                                             <a href="<?php echo site_url('admin/dashboard_admin'); ?>" class="btn btn-secondary fa-solid fa-arrow-left"> Back</a>
                                        </div>
                                   </div>
                              </form>
                         </div>
